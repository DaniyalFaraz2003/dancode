                ...
                return (
                    ...
                    >
                        <box width={COMMAND_COL_WIDTH} flexShrink={0}>
                            <text selectable={false} attributes={isSelected ? TextAttributes.BOLD : undefined} fg={isSelected ? "black": "white"}>
                                /{cmd.name}
                            </text>
                        </box>
                        <box flexGrow={1} flexShrink={1} overflow="hidden">
                            <text selectable={false} attributes={isSelected ? TextAttributes.BOLD : undefined} fg={isSelected ? "black": "gray"}>
                                {cmd.description}
                            </text>
                        </box>
                    </box>
